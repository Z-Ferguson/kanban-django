...
function taskPost(){
    ...
    jQuery.ajax({url:'/api/task/', data:postdata, datatype: 'jsonp', type:'POST'
...
function taskList(){
    var $orderedlist = $("<tr>")
        $.ajax("/api/task/").done(function(results){
...
function delOne(){
    var dropdown = $("#getID")
    jQuery.ajax('/api/task/').done(function(results){
